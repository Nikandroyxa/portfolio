...
I have worked on various Data Science Projects, where I have used **Python**, **SQL**, **Data Preparation**, **Data Cleansing**, **Data Warehousing**, **ETL** and **Machine Learning** libraries like **Pandas**, **Numpy**, **Seaborn**, **Matplotlib**, **Scikit-learn**, **Pycaret**, **Catboost**, **XGBoost**, **Scipy**, **NLTK**. 
